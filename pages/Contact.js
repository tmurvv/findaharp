    ...
    return (
        <div className='contactContainer'>
            ...
            <div className={`contactItem about`}>
                <h2>About us</h2>
                <p style={{textAlign: 'center', marginBlockStart: '0', marginBlockEnd: '2.5em', fontStyle: 'italic', fontSize: '14px'}}>Findaharp.com was designed and developed by harpists Rachael Cooper and Tisha Murvihill.</p>
                <p>Tisha Murvihill is the principal harpist of the Calgary Philharmonic in Alberta, Canada. <blockquote>"Whenever I am trying to help a student find the first or next perfect harp to bring into their lives, I find it difficult to see what is available, especially if the student needs a pre-owned instrument. I have a strong interest in web development, so I decided to combine my interests and create a site for the harp community where they can easily find available pre-owned harps."</blockquote></p>
                <p>Rachael Cooper is the owner/operator of Diomed Design. She is also the proud new owner of a stunning Salvi Apollo pedal harp as well as a an equally stunning "Emilie" lever harp from Newsom Harps in Bragg Creek, Alberta. You can contact Rachael at <a href='www.diomed.ca'>diomed.ca</a>.</p>
