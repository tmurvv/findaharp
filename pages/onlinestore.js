    ...
    return (
        <>
            <div className='index' style={{height: 'fit-content', backgroundColor: '#fffeee', padding: '15px', paddingTop: '70px'}}>
                <PageTitle maintitle="Online Store" subtitle='Currently we offer a handful of CDs and pre-loved music titles. Check back in November, 2020, when we expect to have: ' /> 
