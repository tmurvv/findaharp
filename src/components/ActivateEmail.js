            ...
            <div className='login-signup-container' style={{padding: '40px'}}>   
                <div id="loadingLogin" style={{display: 'block', top: '25%'}}>
                    ...
                    <div className='flex-sb'>
                        <button id='loadingLoginOk' style={{display: 'block'}} type='button' className='submit-btn' onClick={()=>Router.push(Router.query.activateemail.indexOf('notfound')>-1?'/':'/LoginSignup')}>OK</button>
