        ...
        <div className='detailContainer' style={{flexDirection: 'column'}} hidden={!props.open}>
            ...
            <div className='detailInfo'>
                <div className={`detailImg`} style={{marginTop: '43px'}}>
                    <img src= '/img/golden_harp_cropped.png' style={{objectFit: 'contain'}} alt='findaharp golden harp logo' />
                    <img src= '/img/logo_findaharp_black.png' style={{objectFit: 'contain'}} alt='findaharp golden harp logo' />
                </div>
