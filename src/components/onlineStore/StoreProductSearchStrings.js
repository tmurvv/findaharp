   ...
   function clearOneFilter(e) {
    ...
    return (
        ...
        <div className='storeproductSearchOuter'>
            <h3 className='storesearchTitle'>Searching for STRINGS? Refine your search here.<br /><img src='img/Moving_Harp.png' alt='fast truck' style={{width: '45px', transform: 'translate(-6px, 5px)'}}/><span style={{fontStyle: 'normal', fontWeight: 'bold'}}>Fast and Easy</span> string order form coming soon!!</h3>
