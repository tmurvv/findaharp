...
function Octave({strings, octave, applyToOctaves, setApplyToOctaves, setTotal}) {
    ...
    return (
        <>
            <p style={{color: 'grey', fontStyle: 'italic', textAlign: 'center', paddingTop: '25px'}}>{CARDINALS[octave]} Octave {(octave==='0'||octave==='7')&&' (pedal harp only)'}</p>
            {mobile
            ?<><MobileNote note={`Header`} octave={octave} octaveBrand={octaveBrand} setOctaveBrand={setOctaveBrand} applyToOctaves={applyToOctaves} setApplyToOctaves={setApplyToOctaves}/>
                {octave==='0'
                ?<div>
                    <MobileNote note={`${octave}G`} strings={strings} octave={octave} octaveBrand={octaveBrand} setOctaveBrand={setOctaveBrand} setTotal={setTotal} applyToOctaves={applyToOctaves} setApplyToOctaves={setApplyToOctaves}/>
                    <MobileNote note={`${octave}F`} strings={strings} octave={octave} octaveBrand={octaveBrand} setOctaveBrand={setOctaveBrand} setTotal={setTotal} applyToOctaves={applyToOctaves} setApplyToOctaves={setApplyToOctaves}/>
                </div>
                :<>
                    <MobileNote note={`${octave}E`} strings={strings} octave={octave} octaveBrand={octaveBrand} setOctaveBrand={setOctaveBrand} setTotal={setTotal} applyToOctaves={applyToOctaves} setApplyToOctaves={setApplyToOctaves}/>
                    <MobileNote note={`${octave}D`} strings={strings} octave={octave} octaveBrand={octaveBrand} setOctaveBrand={setOctaveBrand} setTotal={setTotal} applyToOctaves={applyToOctaves} setApplyToOctaves={setApplyToOctaves}/>
                    <MobileNote note={`${octave}C`} strings={strings} octave={octave} octaveBrand={octaveBrand} setOctaveBrand={setOctaveBrand} setTotal={setTotal} applyToOctaves={applyToOctaves} setApplyToOctaves={setApplyToOctaves}/>
                    {octave!=='7'
                    &&<>
                        <MobileNote note={`${octave}B`} strings={strings} octave={octave} octaveBrand={octaveBrand} setOctaveBrand={setOctaveBrand} setTotal={setTotal} applyToOctaves={applyToOctaves} setApplyToOctaves={setApplyToOctaves}/>
                        <MobileNote note={`${octave}A`} strings={strings} octave={octave} octaveBrand={octaveBrand} setOctaveBrand={setOctaveBrand} setTotal={setTotal} applyToOctaves={applyToOctaves} setApplyToOctaves={setApplyToOctaves}/>
                        <MobileNote note={`${octave}G`} strings={strings} octave={octave} octaveBrand={octaveBrand} setOctaveBrand={setOctaveBrand} setTotal={setTotal} applyToOctaves={applyToOctaves} setApplyToOctaves={setApplyToOctaves}/>
                        <MobileNote note={`${octave}F`} strings={strings} octave={octave} octaveBrand={octaveBrand} setOctaveBrand={setOctaveBrand} setTotal={setTotal} applyToOctaves={applyToOctaves} setApplyToOctaves={setApplyToOctaves}/>
                    </>} 
                </>}
