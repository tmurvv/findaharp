...
export const STORE_PARTNERS = [
    ...
    },
    {
        ...
        productPrice: "",
        productLongDesc: ` Owner Margaret Weymann Atkinson, Dallas wedding harpist and special event harpist, sought after not only in the Dallas/Ft. Worth metroplex, but across the U.S. and Canada as well. Buyers are welcome from anywhere in the Dallas metroplex, including Dallas, Plano, McKinney, Denton, and Fort Worth, are welcome to schedule an appointment to view any of these beautiful harps. Margaret gladly serves all of North Texas, South Oklahoma to Oklahoma City, and the Tulsa, OK area. If you are outside the areas listed above, contact us. We occasionally have trucks headed to Alabama and Atlanta, Georgia. `,
