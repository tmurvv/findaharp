...
const productsMakesModels = [
    {
        "sellerAliases":[],
        "sellerName":"Aoyama",
        "sellerProducts":[
            {
                "productAliases":["Delphy"],
    ...
    },
    {
        ...
        {
            "productAliases":["Musaleen"],
            "_id":"5e8b7deea03397444c706242",
            "productTitle":"Musaline",
            "productMaker":"Camac",
            "productType":"lever","productSize":38
        },
        {
            "productAliases":["Ulyses","Ulisses","Ulises"],
...
describe('getModelList function', () => {
    ...
    test('should return correct model list', ()=> {
        ...
        // expect(getModelList(productsMakesModels)).toEqual(new Set([
        //     'Irish 34',
        //     'Encore 34',
        //     'Korrigan',
        //     'Hermine',
