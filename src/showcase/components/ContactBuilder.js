...
import ContactBuilderFormCSS from '../styles/ContactBuilder.css';
...
function ContactBuilderForm(props) {
    // shortcut
    ...
    const handleSubmit = async (evt) => {
        ...
        try {
            ...
            resultText.innerText=`Inquiry has been sent to builder.`;
   ...
   return (
        ...
        <div className='builderdetailContainer'>
            ...
            <img className={`buildercontactdivider`} src="./img/tapered_line_blue.png" alt="fancy golden divider line" />
            <div className='contactContainer'>
                <div className={`builderdetailImg`}>
                ...
                <div className='inputGroup'>
                    ...
                    <div style={{marginBottom: '10px', marginTop:'35px', display: 'flex', justifyContent: 'center'}}>
                        <input 
                            ...
                            onChange={handleChange}
                            style={{transform: 'translate(25px, 20px)', zIndex: '3500'}}
                    ...
                    <div>
                        <button
                            className='contactbuilderdetailButton'
                            type='submit'
                            onClick={handleSubmit} 
                        >Submit
                        </button>
                        <button
                            className={`contactbuilderdetailButton builderdetailButton-cancel`}
                            type='button'
                            onClick={() => 
                                {if (!userContact.change ||userContact.change && confirm('Email not sent. Changes will be lost. Exit contact form?')) props.handleCloseContact();
                            }}
        ...
        <ContactBuilderFormCSS />
        </>
    )
}

export default ContactBuilderForm;
