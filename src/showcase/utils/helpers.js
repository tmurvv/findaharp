...
import { STOREPARTNER_PLACEHOLDER, PRODUCTAD_PLACEHOLDER } from '../../main/constants/constants';
...
export function findPriceRange(price, rate) {
    ...
    if (price<1000) return 'Less than $1,000';
    if (price>=1000&&price<2499) return '$1,000-2,499';
    if (price>=2500&&price<3999) return '$2,500-3,999';
    if (price>=4000&&price<6499) return '$4,000-6,499'; 
    if (price>6499&&price<150000) return '$6500 plus';
    // if no number
